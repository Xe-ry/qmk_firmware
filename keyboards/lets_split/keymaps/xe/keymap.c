 ...
 */
[_ADJUST] =  KEYMAP( \
  RESET,  _______,_______,_______,RGB_VAD,RGB_VAI,_______,_______,_______,_______,_______,DEBUG,    \
  KC_MUTE,KC_MPRV,KC_MPLY,KC_MNXT,RGB_SAD,RGB_SAI,_______,XELOMAK,COLEMAK,QWERTY, _______,_______,  \
  _______,_______,_______,_______,RGB_HUD,RGB_HUI,_______,_______,_______,_______,_______,_______,  \
  _______,_______,_______,_______,_______,RGB_SMOD,RGB_TOG,_______,_______,_______,_______,_______   \
)
  ...
  switch (keycode) {
    case XELOMAK:
      if (record->event.pressed) {
        persistent_default_layer_set(1UL<<_XELOMAK);
      }
      return false;
      break;
    case COLEMAK:
